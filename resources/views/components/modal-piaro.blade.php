    ...
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content border-0 rounded-4 shadow-lg">
            ...
            <div class="modal-header border-0 position-relative">
                <div class="w-100 text-center">
                    ...
                    <div class="d-flex justify-content-center gap-4 small mt-2">
                        <span><span class="legend sold"></span> Vendidos</span>
                        <span><span class="legend available"></span> Disponibles</span>
                        <span><span class="legend reserved"></span> Apartados</span>
                    </div>
                </div>
            ...
            <div class="modal-body pt-0">
                <div class="piaro-map-wrapper">
                    <div class="map-container" style="position:relative; display:inline-block;">
                        ...
                        <img src="/img/piaro/1756357825_piaro-masterplan.jpg"
                            class="map-base"
                            alt="Masterplan Piaro"
            ...
            <div class="modal-footer border-0 justify-content-center small">
                ...
                <a href="https://piaro.mx" target="_blank"
                    class="text-primary fw-semibold ms-1">
                    visita su sitio web
                </a>
            </div>
