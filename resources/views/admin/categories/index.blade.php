    ...
    <div class="d-flex justify-content-between align-items-center mb-5">
        <div>
            <h1 class="fw-bold text-gray-800">
                <i class="ki-outline ki-category fs-2 me-2 text-primary"></i>
                Categorías de Productos
            </h1>
            <span class="text-muted fs-7">Gestiona y ordena categorías por estilo</span>
        </div>
        ...
        <div class="col-md-4 mb-4">
            <div class="card shadow-sm h-100">
                ...
                <div class="card-header bg-dark text-white d-flex justify-content-between align-items-center">
                    ...
                    <button class="btn btn-light btn-sm save-order" data-style="{{ $style }}">
                        Guardar Orden
                    </button>
                </div>
                    ...
                    <table class="table table-striped mb-0 table-sm sortable-table" data-style="{{ $style }}">
                        ...
                        <tbody class="sortable">
                            ...
                            <tr data-id="{{ $category->id }}">
                                <td style="padding-left: 30px" class="align-middle text-muted">
                                    {{ $category->orden }}
                                </td>
