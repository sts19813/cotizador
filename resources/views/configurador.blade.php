                ...
                <div class="sticky-content">
                    <div class="gallery-wrapper">
                        ...
                        <div id="owl-demo" class="owl-carousel gallery-carousel">
                            ...
                            <div class="item"><img src="/img/1. IMG/Casas/4. Generales aplica en todas/Baños/B_60X60-ArenaB.jpg" alt="imagen 3" class="thumb" /></div>
                            <div class="item"><img src="/img/1. IMG/Casas/4. Generales aplica en todas/Baños/B_60x60-ArenaN.jpg" alt="imagen 3" class="thumb" /></div>
                        </div>
                ...
                <div class="long-content">
                    ...
                    <div class="accordion " id="configAccordion">
                        ...
                        <div class="accordion-item hover-shadow mb-4">
                            ...
                            <div id="Habitaciones" class="accordion-collapse collapse show" aria-labelledby="headingHabitaciones">
                                <div class="accordion-body">
                                    ...
                                    <div class="row g-3" id="opciones-habitaciones">
                                        <div class="col-md-6">
                                            <div class="option-card estilo-color cursor-pointer" data-id="1Habitacion"
                                                data-valor="1 habitación"
                                                data-precio="0"
                                                onclick="seleccionarHabitacion(this)">
                                                <div class="rounded mb-2 bg-habitaciones d-flex align-items-center justify-content-center" style="height: 100px;">
                                        ...
                                        <div class="col-md-6">
                                            <div class="option-card estilo-color cursor-pointer" data-id="2Habitaciones"
                                                data-valor="2 habitaciones"
                                                data-precio="25000"
                                                onclick="seleccionarHabitacion(this)">
                                                <div class="rounded mb-2 bg-habitaciones d-flex align-items-center justify-content-center" style="height: 100px;">
                                        ...
                                        <div class="col-md-6">
                                            <div class="option-card estilo-color cursor-pointer" data-id="3Habitaciones"
                                                data-valor="3 habitaciones"
                                                data-precio="40000"
                                                onclick="seleccionarHabitacion(this)">
                                                <div class="rounded mb-2 bg-habitaciones d-flex align-items-center justify-content-center" style="height: 100px;">
                                        ...
                                        <div class="col-md-6">
                                            <div class="option-card estilo-color cursor-pointer" data-id="4Habitaciones"
                                                data-valor="4 habitaciones"
                                                data-precio="60000"
                                                onclick="seleccionarHabitacion(this)">
                                                <div class="rounded mb-2 bg-habitaciones d-flex align-items-center justify-content-center" style="height: 100px;">
